#ifndef STROMX_CVCORE_ABSDIFF_H
#define STROMX_CVCORE_ABSDIFF_H
...
namespace stromx
{
    namespace cvcore
    {
        class STROMX_CVCORE_API Absdiff : public runtime::OperatorKernel
        {
        public:
            enum DataFlowId
            {
            ...
            Absdiff();
            virtual OperatorKernel* clone() const { return new Absdiff; }
