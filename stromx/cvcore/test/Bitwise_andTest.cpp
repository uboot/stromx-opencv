...
namespace stromx
{
    namespace cvcore
    {
        ...
        {
            m_operator->setParameter(Bitwise_and::PARAMETER_DATA_FLOW, runtime::Enum(Bitwise_and::MANUAL));
            ...
            m_operator->setInputData(Bitwise_and::INPUT_SRC_1, src1);
            m_operator->setInputData(Bitwise_and::INPUT_SRC_2, src2);
            m_operator->setInputData(Bitwise_and::INPUT_DST, dst);
            
            runtime::DataContainer dstResult = m_operator->getOutputData(Bitwise_and::OUTPUT_DST);
            
            runtime::ReadAccess dstAccess(dstResult);
            cvsupport::Image::save("Bitwise_andTest_testManual0_dst.png", dstAccess.get<runtime::Image>());
        }
        ...
        void Bitwise_andTest::testManual1()
        {
            ...
            runtime::ReadAccess dstAccess(dstResult);
            cvsupport::Image::save("Bitwise_andTest_testManual1_dst.png", dstAccess.get<runtime::Image>());
        }
        
        void Bitwise_andTest::testAllocate0()
        {
            m_operator->setParameter(Bitwise_and::PARAMETER_DATA_FLOW, runtime::Enum(Bitwise_and::ALLOCATE));
            m_operator->initialize();
            m_operator->activate();
