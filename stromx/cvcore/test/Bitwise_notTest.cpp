...
namespace stromx
{
    namespace cvcore
    {
        ...
        {
            m_operator->setParameter(Bitwise_not::PARAMETER_DATA_FLOW, runtime::Enum(Bitwise_not::ALLOCATE));
            m_operator->initialize();
            m_operator->activate();
        ...
        {
            m_operator->setParameter(Bitwise_not::PARAMETER_DATA_FLOW, runtime::Enum(Bitwise_not::IN_PLACE));
            m_operator->initialize();
            m_operator->activate();
            ...
            runtime::DataContainer src1Result = m_operator->getOutputData(Bitwise_not::OUTPUT_SRC_1);
