...
namespace stromx
{
    namespace cvcore
    {
        ...
        {
            m_operator->setParameter(Bitwise_xor::PARAMETER_DATA_FLOW, runtime::Enum(Bitwise_xor::MANUAL));
            ...
            m_operator->setInputData(Bitwise_xor::INPUT_SRC_1, src1);
            m_operator->setInputData(Bitwise_xor::INPUT_SRC_2, src2);
            m_operator->setInputData(Bitwise_xor::INPUT_DST, dst);
            
            runtime::DataContainer dstResult = m_operator->getOutputData(Bitwise_xor::OUTPUT_DST);
            
            runtime::ReadAccess dstAccess(dstResult);
            cvsupport::Image::save("Bitwise_xorTest_testManual0_dst.png", dstAccess.get<runtime::Image>());
        }
        ...
        void Bitwise_xorTest::testManual1()
        {
            ...
            runtime::ReadAccess dstAccess(dstResult);
            cvsupport::Image::save("Bitwise_xorTest_testManual1_dst.png", dstAccess.get<runtime::Image>());
        }
        
        void Bitwise_xorTest::testAllocate0()
        {
            m_operator->setParameter(Bitwise_xor::PARAMETER_DATA_FLOW, runtime::Enum(Bitwise_xor::ALLOCATE));
            m_operator->initialize();
            m_operator->activate();
            ...
            runtime::ReadAccess dstAccess(dstResult);
            cvsupport::Image::save("Bitwise_xorTest_testAllocate0_dst.png", dstAccess.get<runtime::Image>());
        }
