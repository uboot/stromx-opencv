...
namespace stromx
{
    namespace cvimgproc
    {
        ...
        const runtime::DataRef AdaptiveThreshold::getParameter(unsigned int id) const
        {
            switch(id)
            {
            case PARAMETER_ADAPTIVE_METHOD:
            ...
            case(MANUAL):
                {
                    ...
                    m_adaptiveMethodParameter = new runtime::EnumParameter(PARAMETER_ADAPTIVE_METHOD);
        ...
        const std::vector<const runtime::Input*> AdaptiveThreshold::setupInputs()
        {
        ...
        const std::vector<const runtime::Output*> AdaptiveThreshold::setupOutputs()
        {
        ...
        int AdaptiveThreshold::convertAdaptiveMethod(const runtime::Enum & value)
        {
            ...
            default:
                throw runtime::WrongParameterValue(parameter(PARAMETER_ADAPTIVE_METHOD), *this);
            }
        }
