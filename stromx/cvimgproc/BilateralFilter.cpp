...
namespace stromx
{
    namespace cvimgproc
    {
        ...
        const runtime::DataRef BilateralFilter::getParameter(unsigned int id) const
        {
            ...
            case PARAMETER_D:
                return m_d;
            case PARAMETER_SIGMA_COLOR:
                return m_sigmaColor;
            case PARAMETER_SIGMA_SPACE:
                return m_sigmaSpace;
        ...
        const std::vector<const runtime::Parameter*> BilateralFilter::setupParameters()
        {
            ...
            case(MANUAL):
                {
                    m_dParameter = new runtime::NumericParameter<runtime::UInt32>(PARAMETER_D);
                    ...
                    m_sigmaColorParameter = new runtime::NumericParameter<runtime::Float64>(PARAMETER_SIGMA_COLOR);
                    ...
                    m_sigmaSpaceParameter = new runtime::NumericParameter<runtime::Float64>(PARAMETER_SIGMA_SPACE);
        ...
        const std::vector<const runtime::Input*> BilateralFilter::setupInputs()
        {
        ...
        const std::vector<const runtime::Output*> BilateralFilter::setupOutputs()
        {
