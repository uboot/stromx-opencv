...
namespace stromx
{
    namespace cvimgproc
    {
        const std::string CornerMinEigenVal::PACKAGE(STROMX_CVIMGPROC_PACKAGE_NAME);
        const runtime::Version CornerMinEigenVal::VERSION(STROMX_CVIMGPROC_VERSION_MAJOR, STROMX_CVIMGPROC_VERSION_MINOR, STROMX_CVIMGPROC_VERSION_PATCH);
        const std::string CornerMinEigenVal::TYPE("CornerMinEigenVal");
        ...
        const runtime::DataRef CornerMinEigenVal::getParameter(unsigned int id) const
        {
            switch(id)
            {
        ...
        void CornerMinEigenVal::setParameter(unsigned int id, const runtime::Data& value)
        {
            try
            {
                switch(id)
        ...
        const std::vector<const runtime::Parameter*> CornerMinEigenVal::setupInitParameters()
        {
        ...
        const std::vector<const runtime::Parameter*> CornerMinEigenVal::setupParameters()
        {
            std::vector<const runtime::Parameter*> parameters;
