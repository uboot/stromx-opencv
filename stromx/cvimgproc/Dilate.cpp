...
namespace stromx
{
    namespace cvimgproc
    {
        const std::string Dilate::PACKAGE(STROMX_CVIMGPROC_PACKAGE_NAME);
        const runtime::Version Dilate::VERSION(STROMX_CVIMGPROC_VERSION_MAJOR, STROMX_CVIMGPROC_VERSION_MINOR, STROMX_CVIMGPROC_VERSION_PATCH);
        ...
        const runtime::DataRef Dilate::getParameter(unsigned int id) const
        {
            switch(id)
            {
        ...
        void Dilate::setParameter(unsigned int id, const runtime::Data& value)
        {
            try
            {
                switch(id)
        ...
        const std::vector<const runtime::Parameter*> Dilate::setupInitParameters()
        {
        ...
        const std::vector<const runtime::Parameter*> Dilate::setupParameters()
        {
            std::vector<const runtime::Parameter*> parameters;
        ...
        const std::vector<const runtime::Description*> Dilate::setupInputs()
        {
        ...
        const std::vector<const runtime::Description*> Dilate::setupOutputs()
        {
        ...
        void Dilate::execute(runtime::DataProvider & provider)
        {
            switch(int(m_dataFlow))
            {
            case(MANUAL):
        ...
        int Dilate::convertShape(const runtime::Enum & value)
        {
            switch(int(value))
            {
            case MORPH_RECT:
