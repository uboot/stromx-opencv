...
namespace stromx
{
    namespace cvimgproc
    {
        ...
        {
            m_operator->setParameter(MedianBlur::PARAMETER_DATA_FLOW, runtime::Enum(MedianBlur::MANUAL));
            ...
            m_operator->setInputData(MedianBlur::INPUT_SRC, src);
            m_operator->setInputData(MedianBlur::INPUT_DST, dst);
            m_operator->setParameter(MedianBlur::PARAMETER_KSIZE, ksize);
            
            runtime::DataContainer dstResult = m_operator->getOutputData(MedianBlur::OUTPUT_DST);
        ...
        void MedianBlurTest::testManual1()
        {
            ...
            m_operator->setInputData(MedianBlur::INPUT_SRC, src);
            m_operator->setInputData(MedianBlur::INPUT_DST, src);
            m_operator->setParameter(MedianBlur::PARAMETER_KSIZE, ksize);
        ...
        {
            m_operator->setParameter(MedianBlur::PARAMETER_DATA_FLOW, runtime::Enum(MedianBlur::ALLOCATE));
            m_operator->initialize();
            m_operator->activate();
        ...
        {
            m_operator->setParameter(MedianBlur::PARAMETER_DATA_FLOW, runtime::Enum(MedianBlur::IN_PLACE));
            m_operator->initialize();
            m_operator->activate();
            ...
            runtime::DataContainer srcResult = m_operator->getOutputData(MedianBlur::OUTPUT_SRC);
